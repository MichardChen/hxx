...
public class TStoryController extends AbstractController{
	...
	public R save(@RequestParam("tStory")String tStory,@RequestParam("uFile")MultipartFile uploadFile) throws Exception{
		...
		//生成html文件
		try {
			PrintWriter pw = new PrintWriter(new OutputStreamWriter(new FileOutputStream(Constants.HTTPS_FILE_HOST.STORY+uuid+".html"),"utf-8"),true);
		...
		String contentUrl = Constants.HTTPS_HOST.STORY+uuid+".html";
