$(function () {
    $("#jqGrid").jqGrid({
        url: '../tinsurancecommit/list?date=',
        datatype: "json",
        colModel: [			
			{ label: '申请保险产品', name: 'financeId', width: 80 },
...
var vm = new Vue({
	...
	methods: {
		update: function (event) {
			...
			location.href = "tinsurancecommit_add.html?id="+id;
		},
		search:function(event){
			var date = $("#date").val();
			$("#jqGrid").jqGrid('setGridParam',{ 
                url:"../tinsurancecommit/list",
